...
![Home screen with the "How it works" tracker](docs/screenshots/01-home.png)
...
![Dropping a file anywhere on the page](docs/screenshots/a3-upload.png)
...
![Facts shown with confidence scores, with Accept and Edit](docs/screenshots/02-describe.png)
...
![Document preview panel next to the case brief](docs/screenshots/document-panel.png)
...
![Command palette for sharing a case with a lawyer](docs/screenshots/cmd-k.png)
...
![AI chat panel for basic questions](docs/screenshots/ask-nora.png)
...
![Quote ready, with options to accept, ask a question, or push back on price](docs/screenshots/ask-human-1.png)
![Quote ready, with options to accept, ask a question, or push back on price](docs/screenshots/ask-human-2.png)
...
![Confirmation screen with reference number and status](docs/screenshots/05-sent.png)
![Confirmation email with the same case details](docs/screenshots/f4-email.png)
...
![Case brief at 100% confirmed](docs/screenshots/03-confirm.png)
