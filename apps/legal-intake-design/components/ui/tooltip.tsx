 ...
 * `Tooltip` self-wraps in a `TooltipProvider` so call sites don't need one;
 * pass `showArrow={false}` to drop the arrow.
 *
 * Kept in lockstep with `packages/ui/src/components/tooltip.tsx` (the
