    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="text-sidebar-foreground w-(--sidebar-width) border-0 bg-transparent p-2 shadow-none [&>button]:hidden"
          style={
            {
        ...
        >
          ...
          <div className="bg-sidebar ring-sidebar-border shadow-xs flex h-full w-full flex-col rounded-lg ring-1">
            {children}
          </div>
        </SheetContent>
      </Sheet>
...
const sidebarMenuButtonVariants = cva(
  [
    'peer/menu-button relative flex w-full items-center gap-3 overflow-hidden rounded-lg px-2 py-2.5 text-left text-base/6 font-medium ring-sidebar-ring outline-hidden transition-[width,height,padding] sm:py-2 sm:text-sm/5',
    // Touch target: extend the hit area on mobile so each row is >=44px tall
    'before:pointer-events-none before:absolute before:inset-x-0 before:-inset-y-1.5 before:content-[""] sm:before:content-[none]',
    'group-has-data-[sidebar=menu-action]/menu-item:pr-8',
    'group-data-[collapsible=icon]:aspect-square group-data-[collapsible=icon]:!h-auto group-data-[collapsible=icon]:!w-full group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:!justify-center group-data-[collapsible=icon]:!gap-0.5 group-data-[collapsible=icon]:!px-1 group-data-[collapsible=icon]:!py-1 group-data-[collapsible=icon]:text-center group-data-[collapsible=icon]:overflow-visible',
    'group-data-[collapsible=icon]:[&>span:last-child]:whitespace-normal group-data-[collapsible=icon]:[&>span:last-child]:text-xs group-data-[collapsible=icon]:[&>span:last-child]:leading-tight group-data-[collapsible=icon]:[&>svg]:size-5',
    ...
    // Leading icon defaults: bigger on mobile, smaller on desktop
    '[&>svg]:size-6 [&>svg]:shrink-0 sm:[&>svg]:size-5',
    // Avatar slot inside a menu button
  ...
  ].join(' '),
  {
    variants: {
      ...
      size: {
        default: '',
        sm: 'text-xs',
        lg: 'h-14 sm:h-12 group-data-[collapsible=icon]:p-0!',
      },
    },
    defaultVariants: {
      variant: 'default',
