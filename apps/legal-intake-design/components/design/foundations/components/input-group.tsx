...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/input-group border-field relative isolate flex w-full min-w-0 items-center gap-2 rounded-[0.5rem] border bg-transparent text-base',
  ...
  return (
    <input
      ...
      className={cn(
        ...
        'placeholder:text-field-placeholder selection:bg-accent selection:text-accent-foreground flex-1 bg-transparent text-inherit outline-none disabled:cursor-not-allowed',
        className,
      )}
      {...props}
    />
