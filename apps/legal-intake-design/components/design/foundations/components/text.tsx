...
/**
 * Foundation Text family — the dashboard body-copy primitives.
 *
 ...
 * stays on the Inter sans face (the default `font-sans`) and the theme tokens, so
 * body copy reads as a cohesive system. Sizing is mobile-first: a larger base on
 * small screens collapsing to the compact desktop density at the `sm:` breakpoint.
 *
 ...
 * heading's semantics while rendering it as muted body text).
 *
 * Kept in lockstep with `packages/ui/src/components/text.tsx` (the promoted
