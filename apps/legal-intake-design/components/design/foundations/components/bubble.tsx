...
/**
 * Foundation Bubble — design-iteration port of shadcn's `Bubble`. The framed
 * conversational surface for chat text, short structured output, quoted
 * replies, suggestions, and reactions. Scoped to the bubble surface only —
 * avatars, names, timestamps, and message-level actions belong on the
