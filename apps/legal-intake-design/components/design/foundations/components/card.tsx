...
/**
 * Foundation Card — design-iteration copy of the shared shadcn Card, brought
 * into the playground so the surface used across the app (panels, settings
 * sections, the "Danger zone", etc.) can be refined in one place.
 *
 ...
 * a drop-in.
 *
 * TODO(@repo/ui): fold refinements back into `packages/ui/src/components/card.tsx`
