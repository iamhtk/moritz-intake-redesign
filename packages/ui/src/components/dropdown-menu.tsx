...
/**
 * Dropdown Menu — shadcn Dropdown Menu with a refined menu treatment: a rounded
 ...
 * fill with `primary-foreground` text, mirroring the Button). Colors stay mapped
 * to our tokens — no `dark:` utilities (this repo has no class-based dark
 * variant).
 *
 ...
 * `DropdownMenuTrigger` with the `Button` via `asChild`.
 */
