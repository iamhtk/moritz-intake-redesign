...
/**
 * Empty — shadcn's `Empty`, promoted from the design playground's foundation
 * copy. A centered empty-state block with an optional media slot, title,
 * description, and actions.
 *
 * Composition: Empty > EmptyHeader > (EmptyMedia, EmptyTitle,
 * EmptyDescription), with an optional EmptyContent for actions below.
 * `EmptyMedia` frames the glyph either in a muted rounded box (`icon`) or in
 * the hairline ring the onboarding and intake screens use (`ring`).
 */
